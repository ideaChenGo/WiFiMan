...
const char HTTP_CONFIG_WIFI_DEVICE[] PROGMEM = "<form method='get' action='/save'>Wifi configuration<input name='wifiSsid' maxlength='32' placeholder='SSID' required><br/><input name='wifiPasswd' maxlength='32' type='password' placeholder='password'><br/>";
